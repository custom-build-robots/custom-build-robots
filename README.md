...
## 🏫 Right now: robotics in primary schools — Talente-Tour 2026
...
- **Local AI inference at scale** — operating Ollama, vLLM, and llama.cpp with Qwen3, Nemotron-family, Gemma, and other open-weight models. Personal lab on dual NVIDIA RTX A6000 / A6000 Ada workstations; at BMW on Ubuntu-based servers with up to 8x NVIDIA B200 GPUs.
...
`Local LLM/VLM inference` · `Agentic AI (Hermes Agent, OpenClaw, CrewAI)` · `MCP tool calling` · `NVIDIA GPU infrastructure` · `vLLM · Ollama · llama.cpp` · `Embedded robotics (ESP32, Raspberry Pi)` · `Computer vision (YOLO, SAM)` · `Self-driving (Donkey Car, Udacity SDC ND)` · `Industrial AI deployment`
